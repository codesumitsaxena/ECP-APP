    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ padding: "52px 18px 0" }}>
        ...
        <div className="section-block" style={{
          ...
          alignItems: "flex-start", marginBottom: 22, animationDelay: "0ms",
        }}>
          <div>
            <div style={{ fontSize: 14, color: "#64748B", fontWeight: 500 }}>Welcome back,</div>
            <div style={{ fontSize: 28, fontWeight: 900, color: "#0F172A", letterSpacing: -0.5 }}>
              {USER.name}
            </div>
          </div>
          <div
            ...
            style={{
              ...
              fontSize: 15, fontWeight: 900, color: "#1D4ED8",
        ...
        <div className="section-block" style={{
          ...
          boxShadow: "0 4px 20px rgba(59,130,246,0.09)", marginBottom: 28,
          ...
          <div>
            ...
            <div style={{ fontSize: 44, fontWeight: 900, color: "#0F172A", lineHeight: 1, marginBottom: 6 }}>
              {USER.progress}%
            </div>
        ...
        {/* ── Continue Learning ── */}
        <div className="section-block" style={{ marginBottom: 26, animationDelay: "100ms" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
            <h2 style={{ fontSize: 19, fontWeight: 900, color: "#0F172A", margin: 0 }}>Continue Learning</h2>
            <span
              onClick={() => setActiveTab("learn")}
              style={{ fontSize: 13, color: "#3B82F6", fontWeight: 700, cursor: "pointer" }}
            >
              See all →
            </span>
          </div>
        ...
        {/* ── Quick Training ── */}
        <div className="section-block" style={{ marginBottom: 26, animationDelay: "140ms" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
            <h2 style={{ fontSize: 19, fontWeight: 900, color: "#0F172A", margin: 0 }}>Quick Training</h2>
            <span
        ...
        {/* ── Stats Row ── */}
        <div className="section-block" style={{ marginBottom: 28, animationDelay: "170ms" }}>
          <StatRow stats={USER.stats} />
        </div>

        {/* ── Case of the Day ── */}
        <div className="section-block" style={{ marginBottom: 20, animationDelay: "200ms" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
            <h2 style={{ fontSize: 19, fontWeight: 900, color: "#0F172A", margin: 0 }}>Case of the Day</h2>
            <span
      ...
      {toast && (
        <div style={{
          ...
          borderRadius: 28, fontSize: 13, fontWeight: 600,
